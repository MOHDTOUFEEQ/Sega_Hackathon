...
export default function Game() {
	...
	return (
		<div className="game-wrapper">
				...
				<div className="game-over-content relative p-10 rounded-3xl max-w-lg w-full text-center backdrop-blur-[10px] z-10">
					...
					<div className="relative z-10 space-y-10">
						...
						<div className="relative">
							<h1 className="text-9xl font-black text-red-600 tracking-tight">GAME OVER</h1>
			...
			{/* Winner Screen */}
			<EndGameStats isGameOver={isGameOver} handleWinnerResultsClick={handleWinnerResultsClick} gameTime={gameTime} />
		</div>
	);
}
